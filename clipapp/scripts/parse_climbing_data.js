...
const provincesConfig = [
  {
    ...
    nombre: 'Córdoba',
    areas: [
      { name: 'La Cantera', path: 'screens/ruta_pages/la_cantera_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'El Colibrí', path: 'screens/ruta_pages/el_colibri_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'Cueva de las Brujas', path: 'screens/ruta_pages/cueva_de_las_brujas_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'Ascochinga', path: 'screens/ruta_pages/ascochinga_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'Bialet Massé', path: 'screens/ruta_pages/bialet_masse_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'La Calera - El Horno', path: 'screens/ruta_pages/calera_el_horno.dart', subRegion: 'Areas En Cordoba' },
      { name: 'Valle Hermoso', path: 'screens/ruta_pages/valle_hermoso_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'Mina Clavero', path: 'screens/ruta_pages/mina_clavero_page.dart', subRegion: 'Areas En Cordoba' },
      { name: 'La Cueva de los Pajaritos', path: 'screens/ruta_pages/cueva_de_los_pajaritos.dart', subRegion: 'Areas En Cordoba' },
      { name: 'El Secretillo', path: 'screens/ruta_pages/el_secretillo_page.dart', subRegion: 'Altas Cumbres' },
      { name: 'Teatro / Corral', path: 'screens/ruta_pages/teatro_page.dart', subRegion: 'Altas Cumbres' },
      { name: 'La Ola', path: 'screens/ruta_pages/la_ola_page.dart', subRegion: 'Altas Cumbres' },
      { name: 'Zona Torres Gemelas-La Ballena', path: 'screens/ruta_pages/torres_gemelas_page.dart', subRegion: 'Altas Cumbres' },
      { name: 'Los Paredones', path: 'screens/ruta_pages/capila_del_monte/paredones_page.dart', subRegion: 'Capilla Del Monte' },
      { name: 'Mogotes', path: 'screens/ruta_pages/capila_del_monte/mogotes_page.dart', subRegion: 'Capilla Del Monte' },
      { name: 'El Paraiso', path: 'screens/ruta_pages/capila_del_monte/paraiso_page.dart', subRegion: 'Capilla Del Monte' },
      { name: 'Copina I (Segundo Puente)', path: 'screens/ruta_pages/copina/segundo_puente_page.dart', subRegion: 'Copina' },
      { name: 'Copina II (Sector Hernan)', subRegion: 'Copina' },
      { name: 'Copina III (Sector Imperial)', subRegion: 'Copina' },
      { name: 'Copina IV', subRegion: 'Copina' },
      { name: 'Guia General', path: 'screens/ruta_pages/los_gigantes/guia_general_page.dart', subRegion: 'Los Gigantes' },
      { name: 'Cerro de la cruz', path: 'screens/ruta_pages/los_gigantes/cerro_de_la_cruz_page.dart', subRegion: 'Los Gigantes' },
      { name: 'Zona del Refugio C.A.C', path: 'screens/ruta_pages/los_gigantes/zona_del_refugio_page.dart', subRegion: 'Los Gigantes' },
      { name: 'El Ostiazo', path: 'screens/ruta_pages/los_gigantes/el_ostiazo_page.dart', subRegion: 'Los Gigantes' }
    ]
  },
  {
    id: 'mendoza',
